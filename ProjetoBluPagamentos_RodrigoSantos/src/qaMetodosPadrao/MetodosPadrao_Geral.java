...
public class MetodosPadrao_Geral extends IniciaWebDrive{
	
	
	/* Esta é a classe "MetodosPadrao_Geral" do Projeto. Ela é responsavel por conter 
	   todo o codigo fonte que pode ser utilizado em qualquer projeto, pois, os comandos 
	   aqui inseridos são de funções padrão como Click, sendkeys e etc. Esta classe tem 
	   o proposito de normalizar a utilização destes recursos do selenium.
	*/
